...
""");
    ...
    expect(m.faces.first, equals([5, 2, 3]));
    expect(m.faces.last, equals([6, 4, 3]));
  });
...
""");
    ...
    expect(m.faces.first, equals([1, 2, 3]));
    expect(m.faces.last, equals([6, 1, 5]));
  });
...
""");
    ...
    expect(indices.first, equals(2));
    expect(indices.last, equals(6));
  });
