...
""";
  ...
  Pyramid(RenderingContext gl) : super(gl, vshader, fshader) {
  ...
  void draw(Matrix4 mvp, time) {
    ...
    gl.useProgram(program);
    this._drawCube(mvp, time);
  }

  void _drawCube(Matrix4 mvp, time) {
    Matrix4 m = new Matrix4.copy(mvp);
    double xTrans = 10 * sin(this._time / 100000);

    m.translate(xTrans, 0.0, 0.0);
